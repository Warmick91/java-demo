...
CREATE TABLE Veranstaltungen (
	...
	Termin DATE NULL,
	PRIMARY KEY (VerID),
	FOREIGN KEY (SemNr) REFERENCES Seminar (SemNr) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Teilnehmer (
	...
	FOREIGN KEY(VerID) REFERENCES Veranstaltungen (VerID) ON DELETE CASCADE ON UPDATE CASCADE
);
